---
title: "Space Mission: Animated React TypeScript Portfolio Docs"
sidebarTitle: "Home"
description: "Space Mission docs cover setup, pages, and customization for a React 18 TypeScript SPA with animated starfields, orbital visuals, and a sci-fi HUD."
---
...
<Note>
  Space Mission is a static SPA. All page data — projects, skills, work history, blog posts — lives in TypeScript data files under `src/data/`. Edit those files to personalize the portfolio without touching component logic.
</Note>
