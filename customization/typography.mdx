...
description: "Space Mission loads Space Mono, Fraunces, and Inter from Google Fonts. Each font maps to a Tailwind font utility and can be swapped by editing two files."
---
