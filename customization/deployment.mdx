...
description: "Space Mission builds to a static dist/ folder and can be deployed to GitHub Pages, Vercel, Netlify, or any static host. Learn the configuration for each platform."
---
