...
Each orbit is rendered as a CSS ellipse (a `border border-space-white/10 rounded-full` div) plus a Framer Motion rotating wrapper that carries the planet dot.
