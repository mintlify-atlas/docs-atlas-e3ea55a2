...
description: "PageTransition wraps every page in a Framer Motion animation that fades and slides content in on enter and out on exit, coordinated by AnimatePresence in the router."
---
